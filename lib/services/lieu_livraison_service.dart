...
class LieuLivraisonService {
  static const String _baseUrl = 'https://api2.vie-ecoles.com/api/vie-ecoles';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == true && data['data'] != null) {
          ...
          throw Exception(data['message'] ?? 'Erreur lors de la récupération des lieux de livraison');
        }
      } else {

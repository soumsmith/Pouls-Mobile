...
class ParrainageService {
  ...
  static Future<Map<String, dynamic>> getInfoParrainage(
    String phoneNumber,
  ) async {
    try {
      developer.log(
        '🚀 Récupération des infos de parrainage...',
        name: 'ParrainageService',
      );
      developer.log(
        'URL: $baseUrl/vie-ecoles/info-parrainage/$phoneNumber',
        name: 'ParrainageService',
      );
      ...
      developer.log(
        '💥 Exception lors de la récupération: $e',
        name: 'ParrainageService',
      );
      developer.log(
  ...
  static Future<Map<String, dynamic>> submitParrainage({
    ...
    developer.log(
      '🚀 Envoi de la demande de parrainage...',
      name: 'ParrainageService',
    );
    developer.log(
      'URL: $baseUrl/vie-ecoles/parrainer',
      name: 'ParrainageService',
    );
    developer.log(

...
> 2. Accédez à l'onglet / la section des messages.
> 3. Ouvrez une conversation contenant un message audio.
> 4. Lancez la lecture du message audio.
> 5. Retournez sur l'écran d'accueil de l'appareil (mettez l'application en arrière-plan).
> 6. Vous constaterez que l'audio continue d'être diffusé sans interruption.
> 
